...
describe('Line.getIndex', () => {
    ...
    test('identifies edge', () => {
        ...
        expect(topLeft.getIndex(node)).toEqual([1, 3]);
        expect(bottomRight.getIndex(node)).toEqual([1, 3]);
    });
});