 ...
 * @beta
 */
export declare type TypedGeometry = TypedRectangleGeometry | TypedCircleGeometry | TypedLineGeometry;
/**
* Union type of all shape classes.
* @beta
*/
export declare type Shape = Rectangle<any> | Line<any> | Circle<any>;
